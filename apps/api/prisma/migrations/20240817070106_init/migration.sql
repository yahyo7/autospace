...
-- AddForeignKey
ALTER TABLE "Verification" ADD CONSTRAINT "Verification_credentialsUid_fkey" FOREIGN KEY ("credentialsUid") REFERENCES "Credentials"("uid") ON DELETE SET NULL ON UPDATE CASCADE;
